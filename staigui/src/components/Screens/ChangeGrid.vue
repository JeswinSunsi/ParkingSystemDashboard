<template>
	<div class="wrapper">
		<div class="titlebar">Change Parking Lot Dimensions</div>
		<div class="data-fields">
			<div class="flex-row">
				<div class="input">
					<div class="text">NUM SPOTS</div>
...
async function removeCar() {
	try {
		await axios.get(`https://cwapi.jeswinsunsi.repl.co/v1/changegrid/${id.value}`);
		subscribeToChange();
		id.value = "";
	} catch (error) {
		console.error(error);
